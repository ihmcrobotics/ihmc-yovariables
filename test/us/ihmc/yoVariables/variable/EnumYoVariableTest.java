...
public class EnumYoVariableTest
{
   ...
   public void testSetAndGet()
   {
      EnumYoVariable<EnumYoVariableTestEnums> enumYoVariable = new EnumYoVariable<EnumYoVariableTest.EnumYoVariableTestEnums>("enumYoVariable", registry,
            EnumYoVariableTestEnums.class);
      enumYoVariable.set(EnumYoVariableTestEnums.ONE);
      Assert.assertEquals(EnumYoVariableTestEnums.ONE, enumYoVariable.getEnumValue());
      enumYoVariable.set(EnumYoVariableTestEnums.TWO);
      Assert.assertEquals(EnumYoVariableTestEnums.TWO, enumYoVariable.getEnumValue());
   ...
   public void testSetValueAsDoubleOutOfBoundsJustIgnoresIt()
   {
      ...
      Assert.assertEquals(originalValue, enumYoVariable.getEnumValue());
   ...
   public void testForNull()
   {
      ...
      Assert.assertEquals(enumYoVariable.getEnumValue(), null);
   }
   ...
   public void testGetValueAsDouble()
   {
      EnumYoVariable<EnumYoVariableTestEnums> enumYoVariable = new EnumYoVariable<EnumYoVariableTest.EnumYoVariableTestEnums>("enumYoVariable", registry,
            EnumYoVariableTestEnums.class, true);
      enumYoVariable.set(EnumYoVariableTestEnums.ONE);
      Assert.assertEquals(0.0, enumYoVariable.getValueAsDouble(), EPSILON);
      enumYoVariable.set(EnumYoVariableTestEnums.TWO);
      Assert.assertEquals(1.0, enumYoVariable.getValueAsDouble(), EPSILON);
      enumYoVariable.set(null);
      Assert.assertEquals(-1, enumYoVariable.getValueAsDouble(), EPSILON);
   }
   ...
   public void testToString()
   {
      EnumYoVariable<EnumYoVariableTestEnums> enumYoVariable = new EnumYoVariable<EnumYoVariableTest.EnumYoVariableTestEnums>("enumYoVariable", registry,
            EnumYoVariableTestEnums.class);
      enumYoVariable.set(EnumYoVariableTestEnums.ONE);
      Assert.assertEquals("enumYoVariable: ONE", enumYoVariable.toString());
      enumYoVariable.set(EnumYoVariableTestEnums.TWO);
      Assert.assertEquals("enumYoVariable: TWO", enumYoVariable.toString());
   }
   ...
   public void testGetYoVariableType()
   {
      EnumYoVariable<EnumYoVariableTestEnums> enumYoVariable = new EnumYoVariable<EnumYoVariableTest.EnumYoVariableTestEnums>("enumYoVariable", registry,
            EnumYoVariableTestEnums.class);
      Assert.assertEquals(YoVariableType.ENUM, enumYoVariable.getYoVariableType());
   }
   ...
   public void testGetValueAsLongBitsAndSetValueFromLongBits()
   {
      ...
      Assert.assertEquals(longValue, enumYoVariable.getValueAsLongBits());
      ...
      enumYoVariable.set(null);
      Assert.assertEquals(-1, enumYoVariable.getValueAsLongBits());
   }
   ...
   public void testGetEnumType()
   {
      ...
      Assert.assertEquals(enumValue.getClass(), enumYoVariable.getEnumType());
   }
   ...
   public void testDuplicate()
   {
      ...
      Assert.assertEquals(enumYoVariable2.getAllowNullValue(), enumYoVariable.getAllowNullValue());
   }
   ...
   public void testSetValue()
   {
      ...
      Assert.assertEquals(enumValue, enumYoVariable.getEnumValue());
