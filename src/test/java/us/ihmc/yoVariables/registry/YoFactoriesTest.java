...
public class YoFactoriesTest
{
   ...
   public void testGetOrCreateAndAddRegistry()
   {
      ...
      YoRegistry registry000 = YoFactories.findOrCreateRegistry(root, new NameSpace("root.registry0.registry00.registry000"));
      ...
      YoRegistry registry010 = YoFactories.findOrCreateRegistry(root, new NameSpace("root.registry0.registry01.registry010"));
      ...
      assertEquals(registry000, YoFactories.findOrCreateRegistry(root, new NameSpace("root.registry0.registry00.registry000")));
      assertEquals(registry010, YoFactories.findOrCreateRegistry(root, new NameSpace("root.registry0.registry01.registry010")));
   }
}
